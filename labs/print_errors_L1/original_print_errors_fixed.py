...
# These can be repaired with the proper use of the print function
...
print ("one") ("two") ("three")  # keep these all on one line of output
print ("tic" ) print("tak") print("toe") # keep these all on one line of code
prnt "anybody knows that prnt means print
print_now(''I cannot wait any longer'')
print <good grief! This is messed up, too!>
(try it this way!!)print
("Who cares where the verb goes?")print
("Start")print("End")
display("give me a shout when it works")
output: don't mess up on me now!
show -> Please just do what I say!
put >> "The best is yet to come."
cout << "In C++, this works. What about python?";
print            ("Can I do this??")
...
println(<How could something so easy be so difficult?>)
PRINT("does it matter uppercase or lowercase?")
Print 'this ought to work'
p_r_i_n_t ("One letter at a time.
out = That is about enough of this. # print variable out
